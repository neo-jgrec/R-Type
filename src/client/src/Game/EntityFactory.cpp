...
core::ecs::Entity EntityFactory::createPlayer(core::ecs::Registry& registry, const sf::Vector2f& position)
{
    ...
    registry.add_component(player, core::ge::CollisionComponent{.collisionBoxes = {sf::FloatRect(0.0f, 0.0f, 33.0f, 17.0f)}});
...
core::ecs::Entity EntityFactory::createPlayerProjectile(core::ecs::Registry& registry, const sf::Vector2f& startPosition)
{
    ...
    registry.add_component(projectile, core::ge::CollisionComponent{.collisionBoxes = {sf::FloatRect(0.0f, 0.0f, 18.0f, 5.0f)}});
...
core::ecs::Entity EntityFactory::createEnemy(core::ecs::Registry &registry, const sf::Vector2f &position)
{
    ...
    registry.add_component(enemy, core::ge::CollisionComponent{.collisionBoxes = {sf::FloatRect(0.0f, 0.0f, 33.0f, 36.0f)}});
